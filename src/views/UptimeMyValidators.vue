  ...
  <div class="container-md px-0">
    ...
    >
      ...
      <div class="alert-body">
        ...
        <li> Specify parameters like following: <pre>https://explorer.humans.zone/uptime/my?validators={"sifchain":["FBADE9A30473BB9ED6DFA16BFB3838E028F33650"],"chain_name":["hexAddress"]}</pre></li>
      </div>
    </b-alert>
  </div>
</template>
